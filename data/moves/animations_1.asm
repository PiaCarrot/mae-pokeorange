...
BattleAnim_FirePunch:
	...
	anim_call BattleAnim_Fire_branch
	anim_wait 16
	anim_ret
...
BattleAnim_Selfdestruct:
	...
	anim_call BattleAnim_Explosion_branch_2
	anim_wait 16
	anim_ret

.loop
	anim_call BattleAnim_Explosion_branch_1
	anim_wait 5
...
BattleAnim_Recover:
	...
	anim_call BattleAnim_Glimmer_branch
	anim_ret
...
BattleAnim_Growl:
	...
	anim_cry $0
.loop
	anim_call BattleAnim_Sound_branch
	anim_wait 16
	anim_loop 3, .loop
	anim_wait 9
...
BattleAnim_Leer:
	anim_1gfx ANIM_GFX_BEAM
	anim_bgeffect ANIM_BG_CYCLE_OBPALS_GRAY_AND_YELLOW, $0, $2, $0
	anim_call BattleAnim_Leer_branch
	anim_wait 16
	anim_ret
...
BattleAnim_SandAttack:
	...
	anim_call BattleAnim_SandMud_branch
	anim_ret
...
BattleAnim_Harden:
	...
	anim_obp0 $0
	anim_call BattleAnim_TargetObj_1Row_1
	anim_call BattleAnim_Metal_Shine_branch
	anim_call BattleAnim_ShowMon_0_1
	anim_ret
...
.zero
	anim_call BattleAnim_Glimmer_Long_branch
	anim_ret
...
BattleAnim_Poison_Bubble_branch:
.loop
	anim_sound 0, 1, SFX_TOXIC
...
BattleAnim_Glimmer_Long_branch:
	anim_sound 0, 0, SFX_METRONOME
.loop
	anim_obj ANIM_OBJ_GLIMMER, 24, 64, $0
	anim_wait 5
