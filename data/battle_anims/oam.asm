...
; entries correspond to BATTLEANIMOAMSET_* constants
	...
	battleanimoam $00, 18, .OAMData_ea ; BATTLEANIMOAMSET_EA
...
.OAMData_f2:
	...
	dbsprite    2, -4, -2, -2,$04, $0
	dbsprite    3,  1,  0, -2,$04, $0
	dbsprite    4,  4,  0, -2,$04, $0
	dbsprite    9,  4,  0,  0,$04, $0
