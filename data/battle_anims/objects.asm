...
; ANIM_OBJ_ACUPRESSURE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_FF, BATTLEANIMFUNC_ROCK_TOMB, PAL_BATTLE_OB_GRAY, ANIM_GFX_MISC
; ANIM_OBJ_ACUPRESSURE_SPARK
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_F1, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_YELLOW, ANIM_GFX_LIGHTNING
