...
; ANIM_OBJ_WISH_1
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_9B, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS
; ANIM_OBJ_WISH_2
...
; ANIM_OBJ_PUNISHMENT
	battleanimobj RELATIVE_X, $94, BATTLEANIMFRAMESET_108, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_BIG_WHIP
