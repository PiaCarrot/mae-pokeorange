...
; ANIM_OBJ_BLUR_LAUNCH
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_BLUR_LAUNCH, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_BLUR 
; ANIM_OBJ_BLUR_RISING
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_BLUR_RISING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_BLUR
; ANIM_OBJ_BLUR_FALLING
	battleanimobj RELATIVE_X, $f0, BATTLEANIMFRAMESET_BLUR_FALLING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_BLUR
