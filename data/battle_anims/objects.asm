...
; ANIM_OBJ_COSMIC_POWER_BG
	battleanimobj ABSOLUTE_X, $90, BATTLEANIMFRAMESET_E8, BATTLEANIMFUNC_RADIAL_MOVE_OUT_VERY_SLOW, PAL_BATTLE_OB_GREEN, ANIM_GFX_COSMIC_POWER
; ANIM_OBJ_COSMIC_POWER
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS
