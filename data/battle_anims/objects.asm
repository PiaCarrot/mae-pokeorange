...
; ANIM_OBJ_U_TURN_RISE
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_IMP_U_TURN_RISING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_U_TURN
; ANIM_OBJ_U_TURN_FALL
	battleanimobj RELATIVE_X, $f0, BATTLEANIMFRAMESET_U_TURN_FALLING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_U_TURN
