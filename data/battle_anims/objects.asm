...
; ANIM_OBJ_MEDIUM_HORN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_C0, BATTLEANIMFUNC_2C, PAL_BATTLE_OB_GRAY, ANIM_GFX_HORN
...
; ANIM_OBJ_BUBBLE_SPLASH
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_C1, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_BLUE, ANIM_GFX_BUBBLE
