...
; ANIM_OBJ_MINIMIZE
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_MISC_2
...
; 	battleanimobj RELATIVE_X, $a0, BATTLEANIMFRAMESET_21, BATTLEANIMFUNC_25, PAL_BATTLE_OB_BLUE, ANIM_GFX_BUBBLE
; ; ANIM_OBJ_BUBBLE_SPLASH
; 	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_BLUE, ANIM_GFX_BUBBLE
