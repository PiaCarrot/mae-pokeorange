...
; ANIM_OBJ_UPROAR_NOTE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_12, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_UPROAR
; ANIM_OBJ_UPROAR_SPARK
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_13, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_UPROAR
; ANIM_OBJ_UPROAR_SLEEP
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_14, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_UPROAR
