...
; ANIM_OBJ_VORTEX
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLEANIMFRAMESET_E4, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_VORTEX
...
; ANIM_OBJ_SKY_UPPERCUT
	battleanimobj ABSOLUTE_X | PRIORITY, $88, BATTLEANIMFRAMESET_EC, BATTLEANIMFUNC_RADIAL_MOVE_OUT_VERY_FAST_NO_STOP, PAL_BATTLE_OB_BLUE, ANIM_GFX_WIND
