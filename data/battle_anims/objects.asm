...
; ANIM_OBJ_ENERGY_ORB
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_RADIAL_MOVE_IN, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_ENERGY_ORB_OUT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_ENERGY_ORB_OUT_YFIX
	battleanimobj RELATIVE_X | X_FLIP, $10, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
 ; ANIM_OBJ_HEAT_WAVE
