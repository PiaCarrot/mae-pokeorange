...
; ANIM_OBJ_COSMIC_POWER_BG
	battleanimobj ABSOLUTE_X | PRIORITY, $90, BATTLEANIMFRAMESET_E8, BATTLEANIMFUNC_RADIAL_MOVE_OUT_VERY_SLOW, PAL_BATTLE_OB_GREEN, ANIM_GFX_COSMIC_POWER
...
; ANIM_OBJ_WATER_SPOUT_2
	battleanimobj RELATIVE_X, $20, BATTLEANIMFRAMESET_EA, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_WATER
...
; ANIM_OBJ_HAMMER_ARM
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_99, BATTLEANIMFUNC_ROCK_TOMB, PAL_BATTLE_OB_BLUE, ANIM_GFX_HIT
...
; ANIM_OBJ_GYRO_BALL
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLEANIMFRAMESET_FC, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_GYRO_BALL
