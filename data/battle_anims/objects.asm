...
; ANIM_OBJ_MINIMIZE
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_MINIMIZE
; ANIM_OBJ_MEDIUM_HORN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_2C, PAL_BATTLE_OB_GRAY, ANIM_GFX_HORN
