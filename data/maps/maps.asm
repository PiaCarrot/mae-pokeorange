...
MapGroup_NewBark:
	...
	map ValenciaIsland, TILESET_VALENCIA_MANDARIN_NORTH, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_VALENCIA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Tangelo:
	...
	map TangeloIsland, TILESET_VALENCIA_MANDARIN_NORTH, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO | IN_FOGGY, FISHGROUP_OCEAN
	...
	map Route50, TILESET_VALENCIA_MANDARIN_NORTH, ROUTE, LANDMARK_ROUTE_30, MUSIC_STARTER_ORANGE_ROUTE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route51, TILESET_VALENCIA_MANDARIN_NORTH, ROUTE, LANDMARK_ROUTE_31, MUSIC_STARTER_ORANGE_ROUTE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
