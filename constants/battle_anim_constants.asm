...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_JUDGMENT_STREAK_5DEG_R_YFLIP
	const ANIM_OBJ_JUDGMENT_STREAK_45DEG_R_YFLIP
	const ANIM_OBJ_JUDGMENT_STREAK_85DEG_R_YFLIP
	const ANIM_OBJ_JUDGMENT_STREAK_45DEG_L_YFLIP
	const ANIM_OBJ_JUDGMENT_STREAK_85DEG_L_YFLIP
	...
	const ANIM_OBJ_BALL_SPARKLE
	const ANIM_OBJ_BALL_HEARTS
	...
	const ANIM_OBJ_SMALL_EXPLOSION_YFIX
...
;	const ANIM_OBJ_COIN_BURST
;	const ANIM_OBJ_COIN_BUILDUP
	...
	const ANIM_OBJ_DROPLET_R_YFIX
	const ANIM_OBJ_DROPLET_L_YFIX
	const ANIM_OBJ_DRAGON_TAIL
	const ANIM_OBJ_SHOOTING_MIST
	const ANIM_OBJ_SCALD
	const ANIM_OBJ_SCALD_STEAM
	const ANIM_OBJ_V_CREATE_FLAME_SMALL
	const ANIM_OBJ_V_CREATE_FLAME_BIG
	const ANIM_OBJ_V_CREATE_V
...
;	const ANIM_OBJ_PARTING_SHOT_HASH
;	const ANIM_OBJ_PARTING_SHOT_EXCLAMATION
;	const ANIM_OBJ_PARTING_SHOT_STAR
;	const ANIM_OBJ_HEART_BURST
;	const ANIM_OBJ_KINGS_SHIELD
...
;	const ANIM_OBJ_POLLEN_PUFF
;	const ANIM_OBJ_ANCHOR_SHOT
;	const ANIM_OBJ_CHAINS1
;	const ANIM_OBJ_CHAINS2
...
;	const ANIM_OBJ_OBSTRUCT
;	const ANIM_OBJ_LEEK
;	const ANIM_OBJ_SHELL_SIDE_ARM_PHYSICAL
;	const ANIM_OBJ_SHELL_SIDE_ARM_SPECIAL
;	const ANIM_OBJ_SHOOTING_SPARK
;	const ANIM_OBJ_THUNDEROUS_KICK_SPARKS
;	const ANIM_OBJ_EERIE_SPELL
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_BALL_SPARKLE
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_METAL_BURST_GEM
	...
	const BATTLEANIMFRAMESET_COIN_BUILDUP
	const BATTLEANIMFRAMESET_CLEAR_SMOG
	const BATTLEANIMFRAMESET_DRILL_RUN
	const BATTLEANIMFRAMESET_STRUGGLE_BUG
	const BATTLEANIMFRAMESET_ENERGY_ORB_TINY_LONG
	const BATTLEANIMFRAMESET_DRAGON_TAIL
	const BATTLEANIMFRAMESET_FLAME_SMALL_SHORT
	...
	const BATTLEANIMFRAMESET_PARTING_SHOT_EXCLAMATION
	const BATTLEANIMFRAMESET_PARTING_SHOT_STAR
	const BATTLEANIMFRAMESET_KINGS_SHIELD
	const BATTLEANIMFRAMESET_SPIKE_SHIELD_NNE
	const BATTLEANIMFRAMESET_SPIKE_SHIELD_NE
	const BATTLEANIMFRAMESET_SPIKE_SHIELD_E
	const BATTLEANIMFRAMESET_POLLEN_PUFF
	const BATTLEANIMFRAMESET_ANCHOR_SHOT
	const BATTLEANIMFRAMESET_CHAINS_1
	const BATTLEANIMFRAMESET_CHAINS_2
	...
	const BATTLEANIMFRAMESET_OBSTRUCT
	const BATTLEANIMFRAMESET_LEEK
;	const BATTLEANIMFRAMESET_SHELL_SIDE_ARM
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLEANIMOAMSET_136
	const BATTLEANIMOAMSET_137
	const BATTLEANIMOAMSET_138
	const BATTLEANIMOAMSET_139
	const BATTLEANIMOAMSET_13A
	const BATTLEANIMOAMSET_13B
	const BATTLEANIMOAMSET_13C
	const BATTLEANIMOAMSET_13D
	const BATTLEANIMOAMSET_13E
	const BATTLEANIMOAMSET_13F
	const BATTLEANIMOAMSET_140
	const BATTLEANIMOAMSET_141
	const BATTLEANIMOAMSET_142
	const BATTLEANIMOAMSET_143
	const BATTLEANIMOAMSET_144
	const BATTLEANIMOAMSET_145
	const BATTLEANIMOAMSET_146
	const BATTLEANIMOAMSET_147
	const BATTLEANIMOAMSET_148
	const BATTLEANIMOAMSET_149
	const BATTLEANIMOAMSET_14A
	const BATTLEANIMOAMSET_14B
	const BATTLEANIMOAMSET_14C
	const BATTLEANIMOAMSET_14D
	const BATTLEANIMOAMSET_14E
	const BATTLEANIMOAMSET_14F
	const BATTLEANIMOAMSET_150
	const BATTLEANIMOAMSET_151
	const BATTLEANIMOAMSET_152
	const BATTLEANIMOAMSET_153
	const BATTLEANIMOAMSET_154
	const BATTLEANIMOAMSET_155
	...
	const BATTLEANIMOAMSET_15C
	const BATTLEANIMOAMSET_15D
	const BATTLEANIMOAMSET_15E
	const BATTLEANIMOAMSET_15F
	const BATTLEANIMOAMSET_160
	const BATTLEANIMOAMSET_161
	const BATTLEANIMOAMSET_162
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_VERY_BRIGHT_PINK ; 38
	const PAL_BTLCUSTOM_MOONBLAST        ; 39
;	const PAL_BTLCUSTOM_KINGS_SHIELD     ; 3a
...
;	const PAL_BTLCUSTOM_DIRE_CLAW        ; 41
;	const PAL_BTLCUSTOM_COTTON_GUARD     ; 42
